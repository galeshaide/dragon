...
export default function Report() {
  ...
  const models = [
    ...
    {
      name: "Diabetes Risk Analyzer",
      value: "diabetes",
      image: "/images/diabetis.jpg",
    },
    { name: "Heart Cancer", value: "heart", image: "/images/heartcancer.jpg" },
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      if (data.error)
        throw new Error(data.error || data.detail || "Prediction error");
